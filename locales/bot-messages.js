export const botMessages = {
  ...
  start: {
    greeting:
      '👋 Bonjour ! Je suis *ZoomChat*, votre assistant pour rechercher des annonces dans le *Zoom Hebdo*.',
    description:
      "📰 *Le Zoom Hebdo*, c'est le journal N°1 des petites annonces au Gabon, publié chaque vendredi. Je vous aide à trouver rapidement ce que vous cherchez parmi des centaines d'annonces.",
    ...
    subscribe:
      '📬 *Nouveauté !* Abonnez-vous pour recevoir automatiquement le PDF complet chaque vendredi.',
  ...
  search: {
    ...
    queryTooLong: (maxLength) =>
      `⚠️ Votre recherche est trop longue (maximum ${maxLength} caractères).`,
    noResults: (query) =>
